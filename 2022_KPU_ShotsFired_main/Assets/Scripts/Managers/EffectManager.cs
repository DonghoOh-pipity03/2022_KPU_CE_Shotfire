...
public enum EffectKind{ Flesh, Rock, Wood, ThinMetal, Metal, Concrete, Brick, Glass, Plywood,
...
{   
    ...
    [SerializeField] ParticleSystem rockImpact;
    [SerializeField] ParticleSystem woodImpact;
    [SerializeField] ParticleSystem thinMetalImpact;
    [SerializeField] ParticleSystem metalImpact;
    [SerializeField] ParticleSystem concreteImpact;
    [SerializeField] ParticleSystem brickImpact;
    [SerializeField] ParticleSystem glassImpact;
    [SerializeField] ParticleSystem plywoodImpact;
    [SerializeField] ParticleSystem asphaltImpact;
    [SerializeField] ParticleSystem sandImpact;
    [SerializeField] ParticleSystem mudImpact;
    [SerializeField] ParticleSystem groundImpact;
    [SerializeField] ParticleSystem waterImpact;
    [SerializeField] ParticleSystem ceramicImpact;

    GameObject decal;   // 사용할 데칼
    ParticleSystem impact;  // 사용할 파티클시스템
